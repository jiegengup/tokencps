      ...
      <main className="max-w-2xl mx-auto px-6 py-8">
        ...
        <section className="bg-card rounded-xl border border-border-light p-6">
          <div className="space-y-2 mb-4">
            <a href="/buy/docs" className="block text-sm text-text-secondary hover:text-text py-1">用户服务协议</a>
            <a href="/buy/docs" className="block text-sm text-text-secondary hover:text-text py-1">隐私政策</a>
          </div>
