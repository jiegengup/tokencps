    ...
    <div className="min-h-screen bg-bg flex items-center justify-center px-4">
      <div className="w-full max-w-sm">
        ...
        <form onSubmit={handleSubmit} className="bg-card rounded-xl border border-border-light p-6 space-y-4">
          ...
          <p className="text-xs text-text-tertiary text-center">注册即表示同意<Link href="/buy/docs" className="text-accent">服务协议</Link>和<Link href="/buy/docs" className="text-accent">隐私政策</Link></p>
        </form>
        <p className="text-center text-sm text-text-secondary mt-4">
          已有账号？<Link href="/buy/auth/login" className="text-accent hover:text-accent-hover">立即登录</Link>
        </p>
      </div>
    </div>
  )
