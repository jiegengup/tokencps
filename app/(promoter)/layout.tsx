...
import { MobileNav } from '@shared/index'
import { OnboardingModal } from '@/app/components/PromoterOnboardingModal'
...
export default function DashboardLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="min-h-screen bg-cream pb-16 md:pb-0">
      <OnboardingModal open={isNewUser} onClose={() => setNewUser(false)} />
      {/* Desktop sidebar */}
