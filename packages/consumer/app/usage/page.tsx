...
import { api, mockDailyUsage, mockModelUsage } from '@/lib/mock-api'
import type { UsageResponse } from '@tokencps/shared'
...
export default function UsagePage() {
  ...
  const data = range === '7d' ? mockDailyUsage.slice(-7) : mockDailyUsage
