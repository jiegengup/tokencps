...
export const mockDb = {
  users: [
    {
      id: IDS.admin, account: 'admin', password: hashSync('admin123', 10),
      nickname: 'Admin', role: 'admin' as const, balance: 0,
    ...
    {
      id: IDS.promoter, account: 'promoter1', password: hashSync('password123', 10),
      nickname: 'Promoter One', role: 'promoter' as const, balance: 0,
    ...
    {
      id: IDS.consumer, account: 'user1', password: hashSync('password123', 10),
      nickname: 'User One', role: 'consumer' as const, balance: 10,
