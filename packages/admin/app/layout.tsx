...
const NAV_ITEMS = [
  { href: '/', label: '数据看板', icon: 'chart' },
  { href: '/users', label: '用户管理', icon: 'users' },
  { href: '/activities', label: '活动管理', icon: 'activity' },
  { href: '/withdrawals', label: '提现审核', icon: 'wallet' },
  { href: '/announcements', label: '公告管理', icon: 'megaphone' },
  { href: '/coupons', label: '优惠券管理', icon: 'ticket' },
  { href: '/finance', label: '财务报表', icon: 'finance' },
  { href: '/risk', label: '风控告警', icon: 'shield' },
